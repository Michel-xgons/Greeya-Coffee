...
@section('content')
    ...
    <ul class="nav nav-tabs mt-3 px-2 overflow-auto flex-nowrap">
        <li class="nav-item">
            <a class="nav-link fw-semibold text-uppercase text-dark" href="#menu-minuman">
                Minuman
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link fw-semibold text-uppercase text-dark" href="#menu-makanan">
                Makanan
            </a>
        </li>
    </ul>
    ...
    {{-- menu minuman --}}
    <h6 id="menu-minuman" class="bg-secondary text-white text-center fw-semibold rounded py-2 my-3 mx-auto"
        style="max-width:300px;">Minuman
    </h6>
    ...
    {{-- menu makanan --}}
    <h6 id="menu-makanan" class="bg-secondary text-white text-center fw-semibold rounded py-2 my-3 mx-auto"
        style="max-width:300px;">Makanan
    </h6>
    <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-3 mb-4">
